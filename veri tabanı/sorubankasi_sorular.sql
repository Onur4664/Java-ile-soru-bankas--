...
CREATE TABLE `sorular` (
  ...
  `soru` varchar(425) DEFAULT NULL,
  `cevap1` varchar(425) DEFAULT NULL,
  `cevap2` varchar(425) DEFAULT NULL,
  `cevap3` varchar(425) DEFAULT NULL,
  `cevap4` varchar(425) DEFAULT NULL,
  `cevap5` varchar(425) DEFAULT NULL,
...
INSERT INTO `sorular` VALUES (5,'2+3 kac eder?','1','2','3','4','5','Matematik','ORTA'),(8,'h2O nedir?','demir','su','cıva','hava','ateş','Kimya','ORTA');
